...
(function (MCSereneTest) {
    ...
    })(Administration = MCSereneTest.Administration || (MCSereneTest.Administration = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Administration;
    (function (Administration) {
...
(function (MCSereneTest) {
    ...
    })(BasicSamples = MCSereneTest.BasicSamples || (MCSereneTest.BasicSamples = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = MCSereneTest.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = MCSereneTest.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = MCSereneTest.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (MCSereneTest) {
    ...
    })(Common = MCSereneTest.Common || (MCSereneTest.Common = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Common;
...
(function (MCSereneTest) {
    ...
    })(Membership = MCSereneTest.Membership || (MCSereneTest.Membership = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Membership;
...
(function (MCSereneTest) {
    ...
    })(Northwind = MCSereneTest.Northwind || (MCSereneTest.Northwind = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Northwind;
...
(function (MCSereneTest) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'MCSereneTest.Northwind.Gender', 'MCSereneTest.Northwind.Entities.Gender');
    })(Northwind = MCSereneTest.Northwind || (MCSereneTest.Northwind = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
...
(function (MCSereneTest) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = MCSereneTest.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = MCSereneTest.LanguageList || (MCSereneTest.LanguageList = {}));
})(MCSereneTest || (MCSereneTest = {}));
...
(function (MCSereneTest) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('MCSereneTest');
        Serenity.EntityDialog.defaultLanguageList = MCSereneTest.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = MCSereneTest.ScriptInitialization || (MCSereneTest.ScriptInitialization = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Administration;
...
(function (MCSereneTest) {
    ...
    MCSereneTest.BasicProgressDialog = BasicProgressDialog;
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new MCSereneTest.BasicProgressDialog();
...
(function (MCSereneTest) {
    ...
    })(DialogUtils = MCSereneTest.DialogUtils || (MCSereneTest.DialogUtils = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Common;
...
(function (MCSereneTest) {
    ...
    MCSereneTest.StaticTextBlock = StaticTextBlock;
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                MCSereneTest.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(MCSereneTest.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(MCSereneTest.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(MCSereneTest.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        MCSereneTest.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: MCSereneTest.Authorization.userDefinition.DisplayName,
...
(function (MCSereneTest) {
    ...
    (function (Northwind) {
        ...
        }(MCSereneTest.Common.GridEditorDialog));
...
(function (MCSereneTest) {
    ...
    (function (Northwind) {
        ...
        }(MCSereneTest.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return MCSereneTest.LanguageList.getValue();
            };
...
(function (MCSereneTest) {
    ...
    })(Authorization = MCSereneTest.Authorization || (MCSereneTest.Authorization = {}));
})(MCSereneTest || (MCSereneTest = {}));
var MCSereneTest;
(function (MCSereneTest) {
    var BasicSamples;
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.ProductDialog));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.ProductGrid));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: MCSereneTest.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: MCSereneTest.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new MCSereneTest.Northwind.OrderDialog();
                        ...
                        var chai = MCSereneTest.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = MCSereneTest.Northwind.EmployeeRow.getLookup().items
        ...
        }(MCSereneTest.Northwind.OrderGrid));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.OrderDialog));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    MCSereneTest.Northwind.CategoryService.Retrieve({
        ...
        }(MCSereneTest.Northwind.CategoryDialog));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(MCSereneTest.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new MCSereneTest.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                MCSereneTest.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(MCSereneTest.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    MCSereneTest.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(MCSereneTest.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(MCSereneTest.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    MCSereneTest.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return MCSereneTest.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return MCSereneTest.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return MCSereneTest.Northwind.OrderService.baseUrl; };
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.SupplierDialog));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(MCSereneTest.Northwind.SupplierGrid));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return MCSereneTest.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return MCSereneTest.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return MCSereneTest.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return MCSereneTest.Northwind.OrderService.baseUrl; };
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    MCSereneTest.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(MCSereneTest.Northwind.CustomerDialog));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = MCSereneTest.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return MCSereneTest.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new MCSereneTest.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(MCSereneTest.Northwind.OrderDetailDialog));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Northwind.OrderDetailsEditor));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return MCSereneTest.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return MCSereneTest.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return MCSereneTest.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return MCSereneTest.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        ...
        }(MCSereneTest.Common.BulkServiceAction));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return MCSereneTest.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return MCSereneTest.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return MCSereneTest.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(MCSereneTest.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new MCSereneTest.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new MCSereneTest.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new MCSereneTest.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (MCSereneTest) {
    ...
    MCSereneTest.SelectableEntityGrid = SelectableEntityGrid;
})(MCSereneTest || (MCSereneTest = {}));
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return MCSereneTest.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return MCSereneTest.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return MCSereneTest.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(MCSereneTest.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = MCSereneTest.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            MCSereneTest.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return MCSereneTest.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return MCSereneTest.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return MCSereneTest.Northwind.ProductService.baseUrl; };
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return MCSereneTest.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return MCSereneTest.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return MCSereneTest.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return MCSereneTest.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (MCSereneTest) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return MCSereneTest.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return MCSereneTest.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return MCSereneTest.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=MCSereneTest.Web.js.map