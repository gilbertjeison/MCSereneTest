    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your MCSereneTest Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to MARIA C (Serenity Application Template)";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your MCSereneTest Account";
                    ...
                    public static LocalText FormTitle = "Sign up for MCSereneTest";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Maria C";
        }
